					...
					<div class="col-md-12">
						<div class="widget wgreen">
							<div class="widget-head">
								<div class="pull-left">修改会员界面</div>
							...
							<div class="widget-content">
								<div class="padd">				
									<s:form action="modify.action" namespace="/VIP" method="post"  theme="simple"
										enctype="multipart/form-data">

										<div class="form-group">
											<label class="col-lg-4 control-label">会员名</label>
											<s:textfield class="form-control" name="vipmodel.vip_name"   width="210"></s:textfield>
										</div>
